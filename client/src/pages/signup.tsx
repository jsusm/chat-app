...
export default function SignupPage() {
  ...
  const onSubmit = (e: Event) => {
    e.preventDefault()
    setLoading(true)
    auth.signup({ name: name(), password: password() })
      .then(res => {
    ...
    <div class="bg-gray-50">
      <div class="flex justify-center items-center h-[100dvh]">
        <div class="grid max-w-[280px]">
          <h1 class="text-center text-3xl font-extrabold text-slate-800">Sign up</h1>
          ...
          <form onSubmit={onSubmit}>
            <div class="p-3 space-y-6">
              ...
              <div class="flex justify-center">
                <Button loading={loading()} class="block w-full sm:w-auto" >
                  Create Account
                </Button>
              </div>
            </div>
